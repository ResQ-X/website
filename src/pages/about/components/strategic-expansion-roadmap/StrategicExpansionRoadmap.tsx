    ...
    >
      ...
      <div className={`app__row_container ${styles.about__row_container}`}>
        <div className={styles.roadmap_container}>
          {/* Section Title */}
          <AnimatedText
            text="Strategic Expansion Roadmap"
          ...
          <div className={styles.roadmap_text_wrapper}>
            <ContainerReveal>
              <p>
                ...
                with plans for progressive expansion to cover the entire city.
                As we establish a robust operational infrastructure and build
                our subscriber base, we intend to extend our services to other
                key cities within Nigeria. Our phased approach is designed to
                ensure that we can deliver on our commitment to fast and
                reliable response times in the areas where we operate.
              </p>
            </ContainerReveal>

            <ContainerReveal>
              <p>
                By starting in Lagos, we aim to capture a significant market
                share and fine-tune our operations before expanding to other
                regions. Once we have successfully established a strong presence
                in Lagos, our strategic roadmap includes expanding our coverage
                to other cities across Nigeria. We aspire to provide nationwide
                breakdown coverage, ultimately encompassing the entire country
                to serve the diverse needs of car owners across Nigeria.
              </p>
            </ContainerReveal>
            ...
            <ContainerReveal>
              <p>
                ...
                trusted breakdown cover provider in the broader African market.
                In summary, while ResQX will initially focus on Lagos, our
                comprehensive plan involves scaling our services across Nigeria
                This phased approach ensures a meticulous and effective
                expansion that prioritizes the quality and reliability of our
