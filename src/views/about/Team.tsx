  ...
  return (
    <div className="mx-6 mb-[80px] md:mx-[40px]">
      <div className="flex flex-col font-['Raleway'] tracking-[-2%]">
        ...
        <div className="flex flex-col items-center justify-center gap-4 bg-[#faf8f5] lg:flex-row-reverse lg:gap-1">
          {/* Right side - Team members pictures in a circle */}
          <div className="flex items-center justify-center rounded-lg bg-[#faf8f5] lg:w-1/2">
            <div className="py-auto relative h-[400px] max-h-full w-[400px] max-w-full">
              {/* Circle container */}
