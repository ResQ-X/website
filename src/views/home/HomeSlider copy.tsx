...
export const HomeSlider = () => {
  ...
  return (
    <div className="mb-[120px] flex h-[309px] w-full items-center bg-[#FAF8F5] font-['Raleway']">
      <div className="relative  w-full overflow-hidden lg:px-20">
        <div
          ref={HomeCarouselRef}
          className="flex w-full flex-row gap-x-10 transition-transform duration-700 ease-in-out"
