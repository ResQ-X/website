...
export const HomeSliderCard = ({ number, text }: IProps) => {
  return (
    <div className="w-full rounded-2xl bg-white py-20 pl-10 shadow-xl">
      <div className="flex w-full flex-row gap-4">
        ...
        <div className="w-full text-[30px] font-bold leading-[47px] tracking-[-2%] text-[#332414] lg:text-[40px]">
          {text}
        </div>
      </div>
    </div>
