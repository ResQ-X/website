  ...
  return (
    <div className="mb-[100px] border-t-[2px] border-[#faf8f5] bg-white px-0 pb-0">
      <div className="flex flex-col items-end gap-2 lg:flex-row lg:justify-end lg:gap-2 lg:px-10">
        <div className="mt-20 pt-20 lg:my-auto lg:w-1/2">
          <div className="w-full">
            ...
            <div className="flex flex-col items-center justify-center gap-5 pt-10 md:flex-row md:gap-5 lg:justify-start">
              <a
        ...
        <div className="mx-0 w-full px-2 pt-10 lg:w-1/2 lg:px-0">
          <Image
            height={3000}
            width={3000}
            alt="Contact Image"
