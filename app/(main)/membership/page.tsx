...
export const metadata: Metadata = {
  ...
  description:
    "Join ResQ-X membership plans for 24/7 roadside assistance coverage. Enjoy peace of mind with our affordable and reliable subscription services. Sign up today!",
  keywords: [
    "membership plans",
