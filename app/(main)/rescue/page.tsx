...
export const metadata: Metadata = {
  title:
    "Rescue Me - ResQ-X | Fast, Reliable, and Affordable Roadside Assistance Near You",
  description:
    "Need emergency roadside assistance? ResQ-X is here to help! Get fast, reliable, and affordable services like jump starts, fuel delivery, flat tyre changes, and more. Call us now!",
  keywords: [
    "rescue me",
  ...
  alternates: {
    canonical: "https://resqx.ng/rescue",
  },
};
