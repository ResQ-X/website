...
export const metadata: Metadata = {
  ...
  description:
    "Lost or damaged your car keys? ResQ-X provides 24/7 emergency key replacement services to get you back on the road quickly. Call us now for fast and reliable key assistance!",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Lost or damaged your car keys? ResQ-X provides 24/7 emergency key replacement services to get you back on the road quickly. Call us now for fast and reliable key assistance!",
    url: "https://resqx.ng/key-replacement",
    siteName: "ResQ-X",
    type: "website",
    images: [
      {
  ...
  alternates: {
    canonical: "https://resqx.ng/key-replacement",
  },
};
