...
export const metadata: Metadata = {
  ...
  description:
    "Join ResQ-X as a partner and expand your business. Connect with more customers, increase your job opportunities, and deliver top-notch roadside assistance services. Partner with us today!",
  keywords: [
    "partner with ResQ-X",
