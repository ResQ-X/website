...
export const metadata: Metadata = {
  title:
    "Term of use - ResQ-X | Fast, Reliable, and Affordable Roadside Assistance",
  description:
    "Read ResQ-X’s Privacy Policy to understand how we collect, use, and protect your personal information. Your privacy is important to us.",
  keywords: [
    "Term of use",
  ...
  twitter: {
    ...
    title:
      "Privacy Policy - ResQ-X | Fast, Reliable, and Affordable Roadside Assistance",
    description:
      "Read ResQ-X’s Privacy Policy to understand how we collect, use, and protect your personal information. Your privacy is important to us.",
...
export default function Page() {
  return (
    <div className="mt-[100px] pt-[100px]">
      <MarkdownComponent filePath="/files/terms-of-use.md" />
    </div>
  );
}
