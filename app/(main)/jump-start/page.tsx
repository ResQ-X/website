...
export const metadata: Metadata = {
  ...
  description:
    "Need a jump start? ResQ-X provides 24/7 emergency jump start services to get your vehicle running again. Call us now for fast and reliable battery assistance!",
  keywords: [
    "jump start service",
