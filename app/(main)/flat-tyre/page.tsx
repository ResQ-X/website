...
export const metadata: Metadata = {
  ...
  description:
    "Get immediate flat tyre assistance from ResQ-X. Our 24/7 emergency service ensures you’re back on the road quickly and safely. Call us now for help!",
  keywords: [
  ...
  alternates: {
    canonical: "https://resqx.ng/flat-tyre",
  },
};
