...
export const metadata: Metadata = {
  title:
    "Refund Policy - ResQ-X | Fast, Reliable, and Affordable Roadside Assistance",
  description:
    "Read ResQ-X’s Refund Policy to understand our terms and conditions for refunds. We aim to provide fair and transparent refund processes for our customers.",
  keywords: [
    "refund policy",
  ...
  openGraph: {
    ...
    description:
      "Read ResQ-X’s Refund Policy to understand our terms and conditions for refunds. We aim to provide fair and transparent refund processes for our customers.",
    url: "https://resqx.ng/refund-policy",
    siteName: "ResQ-X",
    type: "website",
    images: [
      {
  ...
  alternates: {
    canonical: "https://resqx.ng/refund-policy",
  },
};
