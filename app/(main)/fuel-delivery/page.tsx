...
export const metadata: Metadata = {
  ...
  description:
    "Need fuel delivery? ResQ-X provides 24/7 emergency fuel delivery services to get you back on the road quickly. Call us now for fast and reliable fuel assistance!",
  keywords: [
