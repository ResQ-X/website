...
export const metadata: Metadata = {
  ...
  description:
    "Join ResQ-X and elevate your service business. Connect with more customers, increase your job opportunities, and deliver top-notch roadside assistance services. Sign up today!",
  keywords: [
    "grow with ResQ-X",
  ...
  openGraph: {
    ...
    description:
      "Join ResQ-X and elevate your service business. Connect with more customers, increase your job opportunities, and deliver top-notch roadside assistance services. Sign up today!",
    url: "https://resqx.ng/grow-with-resq-x",
    siteName: "ResQ-X",
    type: "website",
    images: [
      {
  ...
  alternates: {
    canonical: "https://resqx.ng/grow-with-resq-x",
  },
};
