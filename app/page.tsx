...
export const metadata: Metadata = {
  ...
  description:
    "ResQ-X provides 24/7 roadside assistance services, including jump starts, fuel delivery, flat tyre changes, and towing. Get fast, reliable, and affordable help when you need it most.",
  keywords: [
    "roadside assistance",
    "24/7 roadside help",
    "jump start service",
  ...
  openGraph: {
    title:
      "ResQ-X | Fast, Reliable, and Affordable Roadside Assistance Near You",
    description:
      "ResQ-X provides 24/7 roadside assistance services, including jump starts, fuel delivery, flat tyre changes, and towing. Get fast, reliable, and affordable help when you need it most.",
    url: "https://resqx.ng",
    siteName: "ResQ-X",
