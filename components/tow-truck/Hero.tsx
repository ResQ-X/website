    ...
    <>
      <div className="relative z-[-1] h-auto pt-[100px] lg:pt-0 mt-[100px] bg-[#000]">
        ...
        <div className="relative w-full h-full flex flex-col lg:flex-row items-center px-4 sm:px-8 lg:px-16 pt-10 lg:pt-20 pb-[10rem] lg:pb-[22.35rem] overflow-hidden">
          ...
          <div
            ref={textRef}
            className="flex-1 w-full max-w-[821px] text-white text-center lg:text-left"
          >
          ...
          <div
            ref={imageRef}
            className="relative flex-1 flex justify-center items-center mt-10 lg:mt-0"
          >
            {/* Orange Blur Effect */}
            ...
            <div
              className={`relative lg:-translate-x-16 z-10 w-[250px] h-[314px] sm:w-[350px] sm:h-[440px] lg:w-[496.46px] lg:h-[624.14px] ${rotate ? "-rotate-[10deg]" : ""}`}
            >
              {/* Phone Image */}
              <Image
