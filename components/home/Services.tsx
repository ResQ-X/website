...
const services: Service[] = [
  {
    ...
    description:
      "Available 24/7, we offer fast, affordable, friendly, and reliable car towing services with well-equipped tow trucks.",
  ...
  },
  {
    ...
    description:
      "Efficient flat tire assistance, seamlessly integrated into our comprehensive roadside services.",
  ...
  },
  {
    ...
    description:
      "Timely fuel delivery, a vital part of our dependable roadside assistance services.",
  ...
  },
  {
    ...
    description:
      "Prompt and friendly jump-starts, a vital part of our 24/7 roadside assistance. Count on us for swift help",
  ...
  },
  {
    ...
    description:
      "Routine vehicle health checks, your trusted ally for roadside assistance and worry-free journeys.",
  ...
  },
  {
    ...
    description:
      "Swift key replacement, 24/7, for your security and peace of mind. Your trusted partner for breakdown coverage.",
...
const Services: React.FC = () => {
  ...
  const maxIndex = isMobile
    ? services.length - 1
    : Math.min(2, services.length - cardsPerPage);
  ...
  return (
    <section className="py-40 px-4 md:px-8 mx-auto relative overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-12">
        <h2 className="h1-responsive lg:h1 font-[600] text-white">
          OUR SERVICES
        </h2>
      ...
      <div className="overflow-hidden touch-pan-y">
        <div
          ...
          style={{
            width: isMobile
              ? "100%"
              : `${(100 * services.length) / cardsPerPage}%`,
          }}
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="text-center space-y-2 w-full">
                ...
                <h4 className="text-xl md:text-2xl text-black font-bold">
                  {service.subtitle}
                </h4>
              </div>
              ...
              <div className="flex items-center justify-center py-6">
                <div
                  className={`relative w-[181px] h-[103px] ${index === 0 ? "scale-x-[-1]" : ""}`}
                >
                  <Image
                    src={service.image}
                    alt={service.title}
      ...
      <div className="flex justify-center gap-2 mt-6 md:hidden">
        {Array.from(
          { length: services.length - (isMobile ? 0 : 2) },
          (_, i) => (
            <button
              key={i}
      ...
      <Link
        href="/rescue"
        className="w-full flex items-center justify-center my-9"
      >
