...
export const HomeBlogSection = () => {
  return (
    ...
    <h2 className="font-raleway text-center text-[40px] md:text-[64px] font-bold text-lightest mb-12 tracking-tighter">
      Tips for you
    </h2>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          />
          <HomeBlogSectionCard 
            backgroundImage="/images/blog/carImg.jpeg"
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        {/* Full Width Card */}
        <HomeBlogSectionCard 
          backgroundImage="/images/carImg.jpeg"
