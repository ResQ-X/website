...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Requesting service is simple: Open the app and select the type of assistance you need, confirm your location (automatically detected or manually entered), and submit your request. You'll receive immediate confirmation and real-time updates on your service provider's arrival. If you do not have access to the internet, you can reach us on our hotline @ 08111173779"
  },
  {
  ...
  },
  {
    ...
    answer: "Once you request help, you'll be able to see your responder's real-time location on the app. You can also call them directly if you need to talk or check in."
  },
  {
    question: "Is your fee based on distance or how long it takes?",
    answer: "Our fees are based on both the distance and how long the journey takes. We always try to keep it fair and transparent."
  },
  {
    question: "Do you deliver packages too?",
    answer: "We don't offer package delivery at the moment. Our focus is on getting you and your car back on the road safely."
  },
  {
    question: "Can you tow my car to another state?",
    answer: "Yes, we do offer interstate towing. Just let us know where you need to go, and we'll take it from there."
  },
  {
    question: "Do you have a ResQx mechanic workshop?",
    answer: "We don't have our own workshop yet, but we can recommend trusted ones around our service areas (especially on the Island) if your car needs repairs."
  },
  {
    question: "Do I need an account to get roadside assistance?",
    answer: "No, an account is not required. However, creating one helps us serve you better by understanding your needs in advance. If you don't have an account, simply call us at 0811 117 3779."
  },
  {
    question: "I cannot log in to my ResQ-X account, what do I do?",
    answer: "Please send us a support message at hello@resqx.net, or contact us directly at 0811 117 3779 for immediate assistance."
  }
];
